...
export const CosmicSVG = props => {
  return(
    <Svg {...props}  width={props.size} height={props.size} fill={brandColor} alt="Cosmic Division Logo" viewBox="0 0 42 31">
...
export const NateSVG = props => {
  return(
    <Svg {...props}  width={props.size} height={props.size} fill={brandColor} viewBox="0 0 138 138">
