...
export const SvgIcon = ({
  ...
  <View style={tailwind('w-full items-center justify-center text-center')}>
    {children}
    {label1 && (
    <TailwindText weight="bold">{label1}</TailwindText>
    )}
    {label2 && <TailwindText>{label2}</TailwindText>}
  </View>
);
...
NateSVG.defaultProps = {
  size: '48px',
};
CosmicSVG.defaultProps = {
  size: '48px',
};
