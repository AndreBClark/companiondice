...
export const SvgIcon = props => {
  return(
    <View style={tailwind(`h-24 w-full items-center justify-center text-center fill-current`)}>
      {props.Svg}
...
export const NateSVG = props => {
  return(
    <Svg preserveAspectRatio={true} width={props.size} height={props.size} fill={brandColor} viewBox="0 0 138 138">
